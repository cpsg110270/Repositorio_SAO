...
namespace SAO.Migrations
{
    ...
    [Migration("20240115042407_Updated_CuotaImportador_24011422233627")]
    partial class UpdatedCuotaImportador24011422233627
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SAO.Almacens.Almacen", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("SiglaAlmacen")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
                        .HasColumnName("SiglaAlmacen");

                    b.HasKey("Id");

                    b.ToTable("AppAlmacens", (string)null);
                });

            modelBuilder.Entity("SAO.Asraes.Asrae", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("Codigo_ASHRAE")
                        .IsRequired()
                        .HasMaxLength(12)
                        .HasColumnType("nvarchar(12)")
                        .HasColumnName("Codigo_ASHRAE");
            ...
            modelBuilder.Entity("SAO.Exportadors.Exportador", b =>
                {
                    ...
                    b.Property<int>("NoImportador")
                        .HasColumnType("int")
                        .HasColumnName("NoImportador");

                    b.Property<string>("NombreExportador")
                        .IsRequired()
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)")
                        .HasColumnName("NombreExportador");

                    b.HasKey("Id");

                    b.ToTable("AppExportadors", (string)null);
                });

            modelBuilder.Entity("SAO.Fabricantes.Fabricante", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("NombreFabricante")
                        ...
                        .HasColumnName("NombreFabricante");

                    b.HasKey("Id");

                    b.ToTable("AppFabricantes", (string)null);
                });
            ...
            modelBuilder.Entity("SAO.ImporExports.ImporExport", b =>
                {
                    ...
                    b.Property<int>("CantEnvvase")
                        .HasColumnType("int")
                        .HasColumnName("CantEnvvase");
                    ...
                    b.Property<bool>("EsRenovacion")
                        .HasColumnType("bit")
                        .HasColumnName("EsRenovacion");

                    b.Property<bool>("Estado")
                        .HasColumnType("bit")
                        .HasColumnName("Estado");

                    b.Property<Guid>("ExportadorId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("NoPermiso")
                        .IsRequired()
                        .HasMaxLength(8)
                        .HasColumnType("nvarchar(8)")
                        .HasColumnName("NoPermiso");
                    ...
                    b.Property<int?>("PaisProcedenciaId")
                        .HasColumnType("int");

                    b.Property<Guid>("PermisoDe")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("PermisoRenov")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int?>("PuertoEntradaId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PaisProcedenciaId");

                    b.HasIndex("PermisoDe");

                    b.HasIndex("PermisoRenov");

                    b.HasIndex("ProductoId");

                    b.HasIndex("PuertoEntradaId");
                    ...
                    b.ToTable("AppImporExports", (string)null);
                });

            modelBuilder.Entity("SAO.Importadors.Importador", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("NombreImportador")
                        .IsRequired()
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)")
                        .HasColumnName("NombreImportador");

                    b.HasKey("Id");

                    b.ToTable("AppImportadors", (string)null);
                });

            modelBuilder.Entity("SAO.Paiss.Pais", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppPaiss", (string)null);
                });

            modelBuilder.Entity("SAO.Productos.Producto", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("NombreComercia")
                        .IsRequired()
                        .HasMaxLength(90)
                        .HasColumnType("nvarchar(90)")
                        .HasColumnName("NombreComercia");
            ...
            modelBuilder.Entity("SAO.Productos.ProductoSustanciaElemental", b =>
                {
                    b.Property<Guid>("ProductoId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("SustanciaElementalId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("ProductoId", "SustanciaElementalId");

                    b.HasIndex("SustanciaElementalId");

                    b.HasIndex("ProductoId", "SustanciaElementalId");

                    b.ToTable("AppProductoSustanciaElemental", (string)null);
                });

            modelBuilder.Entity("SAO.PuertoEntradaSalidas.PuertoEntradaSalida", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("NombrePuerto")
                        ...
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                        .HasColumnName("NombrePuerto");

                    b.HasKey("Id");

                    b.ToTable("AppPuertoEntradaSalidas", (string)null);
                });

            modelBuilder.Entity("SAO.SustanciaElementals.SustanciaElemental", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("CodCas")
                        .IsRequired()
                        .HasMaxLength(15)
                        .HasColumnType("nvarchar(15)")
                        .HasColumnName("CodCas");

                    b.Property<string>("DesSustancia")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                        .HasColumnName("DesSustancia");
                    ...
                    b.ToTable("AppSustanciaElementals", (string)null);
                });

            modelBuilder.Entity("SAO.TipoEnvases.TipoEnvase", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DesEnvase")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
                        .HasColumnName("DesEnvase");

                    b.HasKey("Id");

                    b.ToTable("AppTipoEnvases", (string)null);
                });

            modelBuilder.Entity("SAO.TipoPermisos.TipoPermiso", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppTipoPermisos", (string)null);
                });

            modelBuilder.Entity("SAO.TipoProductos.TipoProducto", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SAO.UnidadMedidas.UnidadMedida", b =>
                {
                    ...
                    b.ToTable("AppUnidadMedidas", (string)null);
                });
            ...
            modelBuilder.Entity("SAO.ImporExports.ImporExport", b =>
                {
                    b.HasOne("SAO.Almacens.Almacen", null)
                        .WithMany()
                        .HasForeignKey("AlmacenId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("SAO.Exportadors.Exportador", null)
                        .WithMany()
                    ...
                    b.HasOne("SAO.Paiss.Pais", null)
                        .WithMany()
                        .HasForeignKey("PaisProcedenciaId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("SAO.TipoPermisos.TipoPermiso", null)
                        .WithMany()
                        .HasForeignKey("PermisoDe")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("SAO.ImporExports.ImporExport", null)
                        .WithMany()
                        .HasForeignKey("PermisoRenov")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("SAO.Productos.Producto", null)
                        .WithMany()
                        .HasForeignKey("ProductoId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("SAO.PuertoEntradaSalidas.PuertoEntradaSalida", null)
                        .WithMany()
                        .HasForeignKey("PuertoEntradaId")
                        .OnDelete(DeleteBehavior.NoAction);
                    ...
                    b.HasOne("SAO.TipoEnvases.TipoEnvase", null)
                        .WithMany()
                        .HasForeignKey("TipoEnvaseId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("SAO.UnidadMedidas.UnidadMedida", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SAO.Productos.Producto", b =>
                {
                    ...
                    b.HasOne("SAO.Fabricantes.Fabricante", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SAO.Productos.Producto", b =>
                {
                    b.Navigation("SustanciaElementals");
                });
