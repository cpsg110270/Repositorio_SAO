var reportesService = window.sAO.reportes.reportes;
...
function CargarDatos(anio) {
    //Pesos Netos ASHRAE Data

    var arrayPesosNetosASHRAE = [];
    var arrayCodigoASHRAE = [];

    reportesService.getPesosNetosASHRAE(anio).done(function (result) {
        console.log(result);
        result.forEach(function (valor, indice, array) {
            arrayPesosNetosASHRAE.push(valor.pesoNeto);
            arrayCodigoASHRAE.push(valor.codigo_ASHRAE);
        });
        ...
        var optionDonut = {
            ...
            series: arrayPesosNetosASHRAE,
            labels: arrayCodigoASHRAE,
            legend: {
                position: 'left',
                offsetY: 80
            }
    ...
    //Cuotas Importadores Data
    var arrayCuotas = [];
    var arrayPesosNetos = [];
    var arrayImportadores = [];

    console.log(arrayImportadores);

    reportesService.getCuotasImportadoresData(anio).done(function (result) {
        console.log(result);
        result.forEach(function (valor, indice, array) {
            arrayCuotas.push(valor.cuota);
            arrayPesosNetos.push(valor.pesoNeto);
            arrayImportadores.push(valor.importador);
        });
        ...
        var optionsBar = {
            ...
            series: [{
                ...
                name: "Importaciones",
                data: arrayPesosNetos,
            }],
            labels: arrayImportadores,
            xaxis: {
                labels: {
                    style: {
                        colors: '#fff'
