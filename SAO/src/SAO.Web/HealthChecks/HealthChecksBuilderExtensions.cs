...
{
    public static void AddSAOHealthChecks(this IServiceCollection services)
    {
        // Add your health checks here
        var healthChecksBuilder = services.AddHealthChecks();
        healthChecksBuilder.AddCheck<SAODatabaseCheck>("SAO DbContext Check", tags: new string[] { "database" });
